 ...
 * @since 2023-08-22
 */
public interface DfReliabilityDetailsService extends IService<DfReliabilityDetails> {

	List<Map<String, Object>> listByExport(QueryWrapper<DfReliabilityDetails> qw);
