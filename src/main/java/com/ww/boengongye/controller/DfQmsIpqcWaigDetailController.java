 ...
 */
@Controller
@RequestMapping("/dfQmsIpqcWaigDetail")
@ResponseBody
@CrossOrigin
@Api(tags = "外观受检信息")
public class DfQmsIpqcWaigDetailController {
    private static final Logger logger = LoggerFactory.getLogger(DfQmsIpqcWaigDetailController.class);
    ...
    public Object listAll() {
        ...
        return new Result(0, "查询成功",DfQmsIpqcWaigDetailService.list());
    }
    ...
    public Object listByParentId(int id) {
        ...
        return new Result(0, "查询成功",DfQmsIpqcWaigDetailService.listByJoin(qw));
    }
    ...
    public Result listByMachineCode( String machineCode) {
        ...
        ew.inSql("f_parent_id", "select t.id from(select id from df_qms_ipqc_waig_total where status='NG' and f_mac='"+machineCode+"' order by f_time desc limit 0,1) as t");


        return new Result(0, "查询成功",DfQmsIpqcWaigDetailService.list(ew));
...
//        ew.last("limit "+count);
    ...
    public Result fullSizeNGTop5(String factoryId,String process,String lineBody,String item,String startTime,String endTime) {
        ...
        List<DfSizeCheckItemInfos> list= DfQmsIpqcWaigDetailService.fullApperanceNGTop5(factoryId,process,lineBody,item,startTime,endTime);
    ...
    public Result getFpy(@RequestParam String startTime,@RequestParam String endTime) throws ParseException {
        ...
        List<Rate3> fqyList = DfQmsIpqcWaigDetailService.getFpy(fqyWrapper,itemWrapper);
    ...
    public Result getAfterFpy(@RequestParam String startTime,@RequestParam String endTime) throws ParseException {
        ...
        itemWrapper
                .apply("item.check_time >='"+startTime+"'")
                .apply("item.check_time <='"+endTime+"'");
        List<Rate3> fqyList = DfQmsIpqcWaigDetailService.getAfterFpy(fqyWrapper,itemWrapper);
    ...
    public Object checkAoiPassPointHour(){
        ...
        //获取近一小时所有检测项报警信息
        List<Rate4> alarmList = DfQmsIpqcWaigDetailService.getAlarmMessage(dfYieldWarn.getAlarmValue() / 100);
        ...
        //获取近一小时所有检测项预警信息
        List<Rate4> warnList = DfQmsIpqcWaigDetailService.getWarnMessage(dfYieldWarn.getAlarmValue() / 100,dfYieldWarn.getPrewarningValue() / 100);
