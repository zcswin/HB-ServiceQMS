...
//    private JmsTemplate jmsQueueTemplate;
    ...
    public void product_Topic(){
        jmsMessagingTemplate.convertAndSend(topic,"********消息主题：");
    }
...
//    @Scheduled(fixedDelay = 3000)
//    public void product_Scheduled_Topic2(){
//        jmsMessagingTemplate.receive("ActiveMQ.Advisory.Producer.Topic.Param_Iot_Machines_J6-3_J6-3-9");
