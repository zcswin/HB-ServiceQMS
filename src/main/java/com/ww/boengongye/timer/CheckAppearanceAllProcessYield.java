...
public class CheckAppearanceAllProcessYield {
...
//    @Scheduled(initialDelay = 10000,fixedDelay = 60000)
    ...
    public void checkProcessYield() throws ParseException {
         if(env.getProperty("WgYieldWarn","N").equals("Y")){
             ...
             qw3.between("tol.f_time", TimeUtil.getBeforeDay(7),TimeUtil.getYesterday() + " 23:59:59");
             Rate rate=dfQmsIpqcWaigTotalService.getAllYield(qw3);
