...
public class CheckSizeLineYield {
...
//            qw3.between("sd.create_time", TimeUtil.getBeforeDay(7),TimeUtil.getYesterday() + " 23:59:59");
                qw3.between("sd.create_time", TimeUtil.getBeforeDay(7),TimeUtil.getNowTimeByNormal());
                Rate rate=dfSizeDetailService.getLineYield(qw3);
