...
public class DfQmsIpqcWaigTotal extends Model<DfQmsIpqcWaigTotal> {
    public DfQmsIpqcWaigTotal(String okNum1, Integer spotCheckCount1, String totalOkRate,double directConnection1,String fseq,String date1,String fac1,String fbigpro,String fmac,Double ngrate,String ngnum,String fsort) {
        okNum = okNum1;
        spotCheckCount = spotCheckCount1;
        okRate = totalOkRate;
    ...
    public boolean equals(Object o) {
        ...
        DfQmsIpqcWaigTotal that = (DfQmsIpqcWaigTotal) o;
    ...
    List<DfQmsIpqcWaigDetail> detailList;
    ...
    @TableField(exist = false)
    public Double directConnection;
    ...
    public Double getDirectConnection() {
        return directConnection;
    }

    public void setDirectConnection(Double directConnection) {
    ...
    public List<DfQmsIpqcWaigDetail> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<DfQmsIpqcWaigDetail> detailList) {
