...
public class DailySummary {
    ...
    // 完整的构造函数
    public DailySummary(String fStage, String fBigpro, String fColor, String fFac, String fType, String shift, String fSeq, String fTestCategory, String fLine, String fMac, String fTestType, String fTestMan) {
        this.fStage = fStage;
    ...
    // 完整的构造函数
    public DailySummary(String fStage, String fBigpro, String fColor, String fFac, String fType, String shift, String fTestCategory, String fLine, String fMac, String fTestType, String fTestMan) {
        this.fStage = fStage;
        this.fBigpro = fBigpro;
        this.fColor = fColor;
        this.fFac = fFac;
