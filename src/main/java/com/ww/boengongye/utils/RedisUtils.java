...
public final class RedisUtils {
    ...
    /**
     * 自定义序列化类型 List<Map<String, List<Object>>> （存储）
     * @param key
     * @param data
     */
    public void saveListToRedis(String key, List<Map<String, List<Object>>> data) {
        // 通过 JSON 序列化器存储
    ...
    /**
     * 自定义序列化类型 List<Map<String, List<Object>>> （获取）
     * @param key
     * @return
     */
    public List<Map<String, List<Object>>> getListFromRedis(String key) {
        // 通过 JSON 序列化器获取
        redisTemplate.setValueSerializer(new GenericJackson2JsonRedisSerializer());
        return (List<Map<String, List<Object>>>) redisTemplate.opsForValue().get(key);
    }
}
