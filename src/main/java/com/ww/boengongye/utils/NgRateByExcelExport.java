...
public class NgRateByExcelExport {
    ...
    public byte[] NgRateByExport(HttpServletRequest request, HttpServletResponse response, List<Rate> rates, Map<String, List<Object>> resultSheet2, Map<String, List<Object>> resultSheet3, List<Rate> ratesSheet4, List<DfQmsIpqcWaigDetail> datas,String fsort) throws IOException {
    ...
    private static Map<String, Integer> createSheet5Table(Sheet sheet, int firstRow, int firstCol, List<DfQmsIpqcWaigDetail> datas,String fsort) {
        ...
        if (datas != null && !datas.isEmpty()) { // 检查 datas 列表是否为 null 或空
            for (DfQmsIpqcWaigDetail bb : datas) { // 遍历每个 Rate 对象
